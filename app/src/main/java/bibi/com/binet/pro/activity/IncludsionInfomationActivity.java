 ...
 */
public class IncludsionInfomationActivity extends BaseActivity {
    @BindView(R.id.title)
    TextView title;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inclusioninfomation);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.title_imageright:
                startActivity(new Intent(IncludsionInfomationActivity.this,HistoryRecordActivity.class));
